import type { ProviderWorkbenchDef } from "./explorer/provider.js";
import { TFL_REFERENCE_ENTITIES } from "./tfl/reference.js";

export const TFL_PROVIDER: ProviderWorkbenchDef = {
  id: "tfl",
  label: "TfL",
...
export const COMMUTE_PROVIDERS: ProviderWorkbenchDef[] = [TFL_PROVIDER];
