import type { ExplorerEndpointDef, ExplorerEndpointGroup } from "../explorer/types.js";

export const TFL_API_BASE = "https://api.tfl.gov.uk";

const stopPointEndpoints: ExplorerEndpointDef[] = [
  {
    id: "stoppoint-search",
    label: "Search",
  ...
  },
  {
    ...
    label: "Direction To",
    description:
      "GET /StopPoint/{id}/DirectionTo/{toStopPointId} — Inbound or outbound between two stops",
    params: [
...
const lineEndpoints: ExplorerEndpointDef[] = [
  {
    id: "line-by-id",
    label: "By ID",
...
const otherEndpoints: ExplorerEndpointGroup[] = [
  {
    label: "Journey",
    endpoints: [
      {
...
export const EXPLORER_ENDPOINT_GROUPS: ExplorerEndpointGroup[] = [
  { label: "StopPoint", endpoints: stopPointEndpoints },
  { label: "Line", endpoints: lineEndpoints },
  ...otherEndpoints,
];

export const EXPLORER_ENDPOINTS: ExplorerEndpointDef[] = EXPLORER_ENDPOINT_GROUPS.flatMap(
